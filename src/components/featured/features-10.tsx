...
import setupTime from "../../assets/setuptime.png";
			...
			<div className="mx-auto max-w-2xl px-6 lg:max-w-5xl">
				<div className="mx-auto grid gap-4 lg:grid-cols-2">
					<FeatureCard>
						...
						<CardContent className="h-full w-full p-6 pb-0  border-t flex justify-center items-center border-dashed ">
							<img
					...
					<FeatureCard className="p-6 lg:col-span-2">
						<p className="mx-auto my-6 max-w-md text-balance text-center text-2xl font-semibold font-ubuntu">
							Build faster with sensible defaults and optional
							extras—without the boilerplate.
						</p>
