              ...
              {codeContent.map((tab, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    "px-1.5 rounded-sm cursor-pointer ",
                    "first:ml-2.5",
                    "hover:bg-zinc-200/50 dark:hover:bg-zinc-700/70 font-mono",
                    activeTab === index
                      ? "text-zinc-950 dark:text-zinc-50"
      ...
      <div className='relative overflow-hidden'>
        ...
        >
          <span className='relative size-3.5'>
            ...
            >
              <CopyIcon className='size-3' ref={copyRef} />
            </motion.div>
            <motion.div
              initial={false}
              animate={{
        ...
        >
          <AnimatePresence mode='wait' initial={false} custom={direction}>
            ...
            >
              <span className='text-white animate-blink drop-shadow-[0_0_8px_rgba(255,255,255,0.7)]'>
                $
              </span>{" "}
              {currentCode}
            </motion.code>
